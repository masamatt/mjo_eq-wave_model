...
## I. Overview
This repository contains the original model code used in the _Dynamics of Atmospheres and Oceans_ journal article (Schubert and Masarik, 2006)<sup>[\[1\]](#1)</sup>, as well as the MS thesis (Masarik,  2007)<sup>[\[2\]](#2)</sup>.  The description here will follow the later.  The tropical Pacific weather phenomenon most commonly referred to as the _Madden-Julian oscillation (MJO)_ was discovered in 1970 by Roland Madden and Paul Julian, which they reported on in (Madden and Julian, 1971, 1972)<sup>[\[3\]](#3), [\[4\]](#4)</sup>,
