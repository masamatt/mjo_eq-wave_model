...
The second model is contained mostly in the directory `balanced/`, and is derived from the primitive equation potential vorticity (PV) principle along with a linear balance relationship [App ???]() that is valid in the entire equatorial plane, equator included.
<br>
